...
sign_list.append(Sign("templates/template1.png", 0, 100, 200, 255, 255, 255))#1
sign_list.append(Sign("templates/template2.png", 0, 100, 200, 255, 255, 255))#2
sign_list.append(Sign("templates/template3.png", 0, 100, 200, 255, 255, 255))#3
sign_list.append(Sign("templates/template4.png", 0, 0, 0, 255, 10, 255))	 #4
sign_list.append(Sign("templates/template5.png", 80, 0, 0, 155, 255, 255))#5
sign_list.append(Sign("templates/template6.png", 0, 100, 200, 255, 255, 255))#6
sign_list.append(Sign("templates/template7.png", 10, 100, 200, 28, 255, 255))#7
sign_list.append(Sign("templates/template8.png", 0, 100, 200, 255, 255, 255))#8
sign_list.append(Sign("templates/template9.png", 0, 100, 200, 255, 255, 255))#9
sign_list.append(Sign("templates/template10.png", 0, 0, 0, 255, 10, 255))#10
sign_list.append(Sign("templates/template11.png", 40, 0, 0, 90, 255, 255))#11
sign_list.append(Sign("templates/template12.png", 0, 0, 0, 255, 10, 255))#12
