...
while True:
	...
	filtered_blobs = blob_detection(res)
	
	
	for dot in dots_detected:
		print(dot.pt)
		int_pt = (int(dot.pt[0]),int(dot.pt[0]))
		
		#original = cv2.circle(original, int_pt, 30, (0,0,255),-1)
	...
	# Show keypoints
	cv2.imshow("filtered blobs", filtered_blobs)
