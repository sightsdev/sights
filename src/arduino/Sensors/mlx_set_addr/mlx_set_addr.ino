...
const byte oldAddress = 0x5B;
const byte newAddress = 0x5C;
...
void setup() 
{
  ...
  Serial.println ("Trying to connect to old address");
  
  byte address;
  if (!therm.readID()) // Try reading the ID registers
  {
    Serial.println ("Could not connect to old address");
  ...
  {
    Serial.println ("Connected to old address");
