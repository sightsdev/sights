...
$(document).on("ready", function() {
    $('#ssh_new_tab').on("click", function() {
		...
		$("#ssh_iframe_" + ssh_current).attr("src", portString(4200));
    });
