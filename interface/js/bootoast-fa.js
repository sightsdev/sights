/**
 * Modified bootoast to work with Font Awesome instead of glyphicon
 * Modified by SFXRescue <https://github.com/SFXRescue>
 * 
 * AMD adapter!
 * 
...
(function (root, factory) {
	...
	function Bootoast(options) {
		...
		this.$el = $('<div class="' + pluginName + ' alert alert-' + this.typeFor(this.settings.type) + '"><i class="fa fa-fw fa-' + this.settings.icon + '"></i> <span class="bootoast-alert-content">' + this.content + '</span></div>');
